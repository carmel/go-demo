...
func TestMockMethodWithoutArgs(t *testing.T) {
	...
	g := tests.Greeter{&theDBMock, "en"}                             // create tests.Greeter object using mocked db
